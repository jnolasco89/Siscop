 ...
 */
@Embeddable
public class SaldocuentaslPK implements Serializable {
    ...
    public SaldocuentaslPK() {
    }

    public SaldocuentaslPK(long idproyecto, String codigocuenta, long sublibro, int anio, int mes) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof SaldocuentaslPK)) {
            return false;
        }
        SaldocuentaslPK other = (SaldocuentaslPK) object;
    ...
    public String toString() {
        return "sv.org.siscop.caritas.entidades.SaldocuentaslPK[ idproyecto=" + idproyecto + ", codigocuenta=" + codigocuenta + ", sublibro=" + sublibro + ", anio=" + anio + ", mes=" + mes + " ]";
    }
