...
import sv.org.siscop.caritas.ejb.ServicioUsuarioLocal;
...
@SessionScoped
public class MttoUsuario implements Serializable {
    ...
    @EJB
    private ServicioUsuarioLocal servUsuario;

    private final static Logger logger = Logger.getLogger(MttoUsuario.class.getName());

    public MttoUsuario() {
    }

    FacesContext facesContext = FacesContext.getCurrentInstance();    //Campos de búsqueda Usuarioes
    ...
    private Usuario proveedorSelB = new Usuario();
    ...
    //<editor-fold defaultstate="collapsed" desc="Getter and Setter Usuarioes">
    ...
    public void setUsuarioActual(Usuario proveedorActual) {
        this.usuarioActual = proveedorActual;
    }

    public Usuario getUsuarioSelB() {
        return proveedorSelB;
    }

    public void setUsuarioSelB(Usuario proveedorSelB) {
...
//</editor-fold>
    ...
    public void buscarUsuarios() {
        ...
        try {
            ...
            if (hayDui) {
                ...
                lstUsuarios = servUsuario.buscarUsuarios(filtro);
            }
    ...
    public void onRowSelectUsuario(SelectEvent event) throws IOException {
        try {
            limpiarUsuario();
...
//            PrimeFaces.current().ajax().update(":formbuscarPersona");
    ...
    public void guardarUsuario() {
        try {
            ...
            this.usuarioActual = new Usuario(personaActual.getId());
            this.usuarioActual.setPersona(personaActual);

            this.servUsuario.guardarUsuario(personaActual, usuarioActual, nuevoUsuario);
            ...
            this.showMessage(FacesMessage.SEVERITY_INFO, "Usuario guardado exitosamente.", null);
